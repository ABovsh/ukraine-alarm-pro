...
- **Останні 24 години.** Смуга доби: червоні й жовті відрізки — тривоги, їх кількість і
  загальна тривалість. Навівши курсор на відрізок, видно його початок, кінець і тривалість.
- **7 днів.** Стовпчик на кожен день: висота — тривалість тривог, число над ним — їх
  кількість. Нижче — найдовша й середня тривога тижня та час останньої.
- **Дані.** Чи актуальні дані, коли оновилися, остання подія.
...
вимкнути статистику, увімкнути компактний вигляд або обрати мову.
...
show_stats: true                    # false — без статистики за 24 години й 7 днів
compact: false                      # true — лише верхній рядок, без статистики
